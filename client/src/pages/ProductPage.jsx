    ...
    <main className="detail-page">
      ...
      <section className="product-layout">
        <article className="reference-product-panel">
          ...
          <div className="product-showcase" data-brand={product.brand.toLowerCase()}><div className="showcase-ring"/><img key={variant.imageUrl} src={variant.imageUrl} alt={`${product.name} in ${variant.color}`}/></div>
